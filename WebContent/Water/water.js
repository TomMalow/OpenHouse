		...
		init: function(options) {
			...
			return $(this).each(function() {
				with({$this:$(this)}) {
					...
					$this.find(".reset").live('touchend click', function() {
						$this.water("gameover");
					});
					...
					$this.find(".fill-bottle3").live('touchend click', function() {
						$this.water("alterWater",3,true);
					});
					$this.find(".fill-bottle5").live('touchend click', function() {
						$this.water("alterWater",5,true);
					});
					$this.find(".empty-bottle3").live('touchend click', function() {
						$this.water("alterWater",3,false);
					});
					$this.find(".empty-bottle5").live('touchend click', function() {
						$this.water("alterWater",5,false);
					});
					$this.find(".transfer-3to5").live('touchend click', function() {
						$this.water("transfer",35);
					});
					$this.find(".transfer-5to3").live('touchend click', function() {
